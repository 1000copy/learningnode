...
我们重新创建和初始化仓库，以及边创建实验环境，这一次我们的目的，是观察合格验证head的变化规律。
...
两相对比，如我们的期望：
    ...
    $git rev-parse HEAD 
    e0633b188b86573428c3d89e75ca6b1646933ad0
    $git log --pretty=oneline
	e0633b188b86573428c3d89e75ca6b1646933ad0 r1
	$git rev-parse --abbrev-ref HEAD
	master
	
head 指向的SHA1 和git log中第一个提交的SHA1一致。图示如下
