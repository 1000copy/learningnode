...
这是一篇[nodebeginner](http://www.nodebeginner.org/)的阅读笔记。结构来自于nodebeginer ，甚至我根本就是基于中文版本，边看边删除和修改的。可取之处在于：

-简洁：行文简化，代码也做了重构。并且表意也直接（总觉得别人啰嗦）。还忽略和模块等和主题不太相关的内容。
-也有些我的想法。比如curl替代browser做响应验证

要是你比较善良，你可以理解我的工作是一次重构。

经过这个工作，我更好的学习了原文，更好的体会的node的精要之处。因此，我认为也会帮你花费更少的时间，学到同样甚至更多的技术。
所以感谢nodebeginer的作者和译者的工作。
